...
XPKG_IGNORE = .github/workflows/ci.yaml,.github/workflows/tag.yml,.github/workflows/e2e.yaml,init/*.yaml,.up/examples/upbound/*.yaml,.work/uptest-datasource.yaml,.up/config/*/*,.up/examples/datadog.yaml
